<template>
  <div class="content-wrapper" v-loading.fullscreen.lock="loading" element-loading-text="拼命加载中" element-loading-spinner="el-icon-loading" element-loading-background="rgba(0, 0, 0, 0.8)">
    ...
    <div class="class-filter eca-content-section">
      ...
      <div class="course-add-btn" @click="openAddCourseDialog()">
    ...
    <!-- 模态框容器 -->
    <div>
      <el-dialog @open="onclassDetailDialogOpen" class="eca-dialog-header" title="课程信息" v-if="classDetailDialogVisible" :visible.sync="classDetailDialogVisible" width="1152px">
        <div slot="title">
...
export default {
  ...
  mounted() {
    var vm = this;
    // var endPointSwiper = new Swiper('.swiper-container', {
    ...
    //   }
    // });
    // var feedBackSwiper = new Swiper('#clientFeedbackSwiper', {
    //   pagination: '.swiper-pagination',
    //   paginationClickable: true
    // });
    function calDomWH() {
